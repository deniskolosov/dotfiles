	...
	},
	{
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        wk.add({
          ...
          --  This is where a variable was first declared, or where a function is defined, etc.
          --  To jump back, press <C-t>.
          { "<leader>ld", "<cmd>lua require('telescope.builtin').lsp_definitions<cr>" , desc = "Go to Definition" },
          { "<leader>lD", vim.lsp.buf.declaration, desc = "Go to Declaration" },
          { "<leader>lh", vim.lsp.buf.hover, desc = "Show Hover Information" },
          { "<leader>lH", vim.lsp.buf.signature_help, desc = "Show Signature Help" },
          { "<leader>lr", vim.lsp.buf.references, desc = "Find References" },
          { "<leader>la", vim.lsp.buf.code_action, desc = "List Code Actions" },
          { "<leader>lR", vim.lsp.buf.rename, desc = "Rename Symbol" },
          { "<leader>lf", vim.diagnostic.open_float, desc = "Show Line Diagnostics" },
          ...
          --  Similar to document symbols, except searches over your entire project.
          { "<leader>lS", builtin.lsp_dynamic_workspace_symbols, desc = "Lsp Document Symbols" },
        }, { prefix = "<leader>" })
			end
